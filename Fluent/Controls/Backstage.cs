...
namespace Fluent
{
    ...
    public class Backstage : RibbonControl
    {
        ...
        public static readonly DependencyProperty IsLockedProperty =
            DependencyProperty.Register("IsLocked", typeof(bool), typeof(Backstage), new UIPropertyMetadata(false, onIsLockedChanged));


        private bool _storeEnabledState = true;
